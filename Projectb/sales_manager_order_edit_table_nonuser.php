		...
		<style>            ///////////////////////////STYLE INFO///////////////////////////
			...
			<body>
			  ...
			  <tr>
				...
				<br>
				<br>
				<form action="Edit_info_Order_as_Manager_for_nonuser_Algo.php" method="POST">
				  <!--<input type="text" name="Order_ids" placeholder="Enter new order id">-->
				  <input type="text" name="Customer_Information" placeholder="Enter new customer information">
			...
			$row = mysqli_fetch_assoc($result);
			  ...
			  echo "<tr>" . "<th>" . $order_id . "</th>" . "<th>" . $customer_info . "</th>" .   "<th>" . $invoice_id . "</th>" . "<th>" . $address . "</th>"  . "</tr>"; 			
